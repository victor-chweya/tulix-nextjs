        ...
        <div className="container">
          <div className="row justify-content-center text-center">
            <div className="col-lg-6">
              ...
              <p className="mb-5">
                Get updates on all of our news, events or updates and be the
                first to get notified.
              </p>
              ...
              <div id="mc_embed_signup">
                <form
                  action="https://app.us2.list-manage.com/subscribe/post?u=1f7c48c812ea5de5f89ea5e77&id=4042104668"
                ...
                >
                  ...
                  >
                    <input
                      type="text"
                      name="b_1f7c48c812ea5de5f89ea5e77_4042104668"
                      tabIndex={-1}
                      defaultValue=""
                    />
                  </div>
                  <button
                    ...
                    className="btn btn-primary btn-lg mb-2 col"
                    type="submit"
                  >
                    Sign up today
                  </button>
