        ...
        <div className="container">
          <div className="row justify-content-lg-center ">
            <div className="col-lg-8 pb-5">
              ...
              <p>
                Welcome to Tulix (“<strong>Company</strong>”, “
                <strong>we</strong>”, “<strong>our</strong>”, “
                <strong>us</strong>”)! As you have just clicked our Terms of
              ...
              <p>
                ...
                <strong>Terms of Service</strong>”) set out the legally-binding
                terms and conditions for governing the use of our web pages
                located at <a href="./">tulix.app</a> and our mobile application
                Tulix App (together or individually “<strong>Service</strong>”)
                operated by Tulix.
              </p>
              <p>
              ...
              <p>
                ...
                have read and understood Agreements, and agree to be bound by
                them
              </p>
              <p>
              ...
              <p>
                Tulix is a person-to-business (P2B) payments platform,
                facilitating payments by individuals both abroad and locally for
                purchase of retail goods and services offered by businesses
                located in Kenya. Pursuant to this, Tulix has partnered with an
                existing and reputable digital Remittance Service Provider
                (RSP), Stripe, to ensure secure transmission of funds.
              </p>
              <h5>4.Purchases</h5>
              <p>
                If you wish to purchase any product or service made available
                through Service (“<strong>Purchase</strong>”), you may be asked
              ...
              <p>
                ...
                <strong>Subscription(s)</strong>”). You will be billed in
                advance on a recurring and periodic basis (“
                <strong>Billing Cycle</strong>”). Billing cycles are set either
              ...
              <h5>7.Fee Changes</h5>
              <p>
                Tulix, in its sole discretion and at any time, may modify fees.
              </p>
              <p>
                Tulix will however provide you with reasonable prior notice of
                any change in fees before such change becomes effective.
              </p>
              <p>
                Your continued use of Service after fee change comes into effect
                constitutes your agreement to pay the modified fee amount.
              </p>
              <h5>8.Refunds</h5>
              <p>Except when required by law, paid fees are non-refundable.</p>
              <h5>9.Reliance by Tulix</h5>
              <p>
                Use care when inputting Beneficiary and Merchants details. When
                inputting Beneficiaries, ensure that their names are spelt
                correctly and provide in full, and verify that you have provided
                us with the Beneficiary’s correct phone number. For Merchants,
                ensure that you have input the correct Till or Paybill Number.
                You represent and warrant to us that all information you enter
                into the Application or otherwise provide to Tulix is true and
                complete, including information about you, your Payment Account,
                and your Beneficiary. You acknowledge that any errors in the
                information you provide, including misidentification of
                Beneficiary(s), incorrect or inconsistent Till and Paybill
                numbers, or misspellings, are your responsibility.
              </p>
              ...
              <p>
                ...
                to a beneficiary’s wallet can be rectified (including all fees,
                if any) within three (3) business days provided funds have not
                been utilized. In the case of making payments to merchants
                located in Kenya, given the fact that Tulix forwards funds
              ...
              <p>
                The App allows for reversals of all amounts allocated due to
                account number, telephone number, Beneficiary name or other
                information incorrectly input, provided that the amount has not
                yet been utilized. You may be unable to perform a reversal if
                your allocation has already been utilized to make a payment out
                to a merchant in accordance with the information you provided.
              </p>
              <p>
                ...
                payment details (where applicable), the date of your transfer,
                as well as the reason you believe there has been an error. Tulix
                will investigate and determine whether an error occurred, and we
                will complete the investigation within 60 days. We will inform
                you of the results of the investigation within three (3)
                business days after the investigation is completed. If Tulix was
                at fault, we will refund the total amount you paid, including
                fees, if any, within one business day, or as soon as reasonably
                practicable.
              </p>
              <p>
                Tulix will pay all refunds (whether resulting from a cancelled
                or disputed payment or allocation) by a credit to your Wallet.
                Alternatively, you can choose to have Tulix process the
                allocation or payment again for no additional charge. Except for
                our obligation to investigate and refund described above, Tulix
                is not liable to you for any loss resulting from Tulix’s
                inability to cancel or refund a payment.
              </p>
              <h5>11.Content</h5>
              <p>
              ...
              <p>
                Tulix has the right but not the obligation to monitor and edit
                all Content provided by users.
              </p>
              <p>
                In addition, Content found on or through this Service are the
                property of Tulix or used with permission. You may not
              ...
              <p>
                ...
                least eighteen (18) years old. By accessing or using any of the
                Company’s services, you warrant and represent that you are at
                least eighteen (18) years of age and with the full authority,
                right, and capacity to enter into this agreement and abide by
                all of the terms and conditions of Terms. If you are not at
                least eighteen (18) years old, you are prohibited from both the
                access and usage of Service.
              </p>
              <h5>14.Accounts</h5>
              <p>
                To access and use the Services, you must create a User Account
                which shall be solely accessible using a username and password
                set by you.
              </p>
              <p>
                Prospective customers shall provide documentary evidence to
                ascertain their true identity, with acceptable forms of official
                record including:
              </p>
              <ul>
              ...
              <p>
                Supporting documentation required as part of the customer due
                diligence process during registration are:
              </p>
              <ul>
              ...
              <p>
                ...
                restriction of access to your device and/or account. You agree
              ...
              <p>
                ...
                exclusive property of Tulix and its licensors. Service is
                protected by copyright, trademark, and other intellectual
                property laws. Our trademarks and trade dress may not be used in
              ...
              <p>
                You may provide us either directly at hello@tulix.app or via
              ...
              <p>
                ...
                services that are not owned or controlled by Tulix.
              </p>
              <p>
                Tulix has no control over, and assumes no responsibility for the
              ...
              <p>
                YOU ACKNOWLEDGE AND AGREE THAT TULIX SHALL NOT BE RESPONSIBLE OR
              ...
              <ul>
                <li>
                  By email: <a href="mailto:hello@tulix.app">hello@tulix.app</a>
                  .
                </li>
                <li>
